...
public class GameplayLoopIntegrationTest
{
    ...
    public IEnumerator TestFullGameplayLoop_SuccessfulPizza()
    {
        ...
        float sauceVolumeRequired = sauceRecognizer.SauceVolumeRequired;
        sauceRecognizer.registerSauceAmount(sauceVolumeRequired); // Trigger completion
    ...
    public IEnumerator TestFullGameplayLoop_BurntPizza()
    {
        ...
        sauceRecognizer.setCanBeSauced(true);
        float sauceVolumeRequired = sauceRecognizer.SauceVolumeRequired;
        sauceRecognizer.registerSauceAmount(sauceVolumeRequired);
